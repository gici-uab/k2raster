...
#include <rp-utils/LogSequence.h>
#include <rp-utils/DAC_VLS.h>
#include <rp-utils/Utils.h>
...
class RePair
{
	public:
		...
		uint getNumOfRules() {return this->rules;};

        uint getNumOfTernimals() {return this->terminals;};

		LogSequence *getGrammar() {return this->G;};
